            ...
            <div class="card-body">
              ...
              {{ csrf_field() }}
                ...
                <div class="col-12">
                  ...
                  <input type="text" value="{{ $getRecord->mobile }}" class="form-control" id="inputEmail4"name="mobile"  >
                ...
                <div class="col-12">
                  ...
                  <input type="password" class="form-control" name="confirmPassword" id="inputPassword4">
                </div>
